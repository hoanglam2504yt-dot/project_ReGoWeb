                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="flex items-start gap-2 pt-2 pb-4">
                            ...
                            <label htmlFor="terms" className="text-xs text-gray-500 leading-relaxed cursor-pointer select-none">
                                ...
                                <a href="#" className="font-medium text-indigo-600 hover:underline">Chính sách Bảo mật</a> của chúng tôi.
                            </label>
                        </div>
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full py-3 bg-[#4F46E5] text-white rounded-lg font-semibold hover:bg-[#4338CA] transition shadow-sm disabled:opacity-70 disabled:cursor-not-allowed font-[Inter]"
                        >
