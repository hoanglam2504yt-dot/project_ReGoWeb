    ...
    <div className="space-y-8">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <div className="flex-1 relative">
            <input
              ...
              className="w-full px-4 py-3 pl-10 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-purple-500 focus:border-transparent"
            />
      ...
      {loading && (
        <div className="text-center py-12">
          <FaSpinner className="inline-block animate-spin text-4xl text-purple-600 mx-auto" />
      ...
      {!loading && filteredProducts.length === 0 && (
        <div className="text-center py-12">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-6">
            {searchKeyword ? "Không tìm thấy sản phẩm phù hợp." : "Hãy là người đầu tiên đăng tin trong danh mục này!"}
          </p>
          <div className="flex gap-4 justify-center">
            <button
              onClick={() => navigate("/")}
              className="px-6 py-3 bg-gray-600 text-white rounded-full font-semibold hover:bg-gray-700 transition"
            >
              Quay lại trang chủ
            </button>
            <Link
